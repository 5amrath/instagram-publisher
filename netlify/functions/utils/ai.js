  ...
  try {
    const payload = JSON.stringify({
      ...
      messages: [
        {
          role: 'system',
          content: `You write Instagram Reels captions for @ascend.deals â a male self-improvement and affiliate deals account. Looksmaxxing, skincare, grooming, forward growth, lifestyle products.
