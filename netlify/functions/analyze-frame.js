...
- 6-8 hashtags total, no more`,
      },
      {
        ...
        content: [
          {
            type: 'text',
            text: 'Look at this video thumbnail. Identify what the product/topic is, then write a Reels caption following the rules. Make the hook irresistible â something that stops the scroll.',
          },
          {
            type: 'image_url',
